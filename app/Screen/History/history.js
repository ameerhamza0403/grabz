    ...
    return (
      <SafeAreaView>
        ...
        <Text
          ...
          {'Posted Jobs History'.toUpperCase()}
        </Text>
        <ScrollView>
          <View
            style={{
                  ...
                  {e.status == 'pending' && (
                    <TouchableOpacity
                      onPress={() => {
                        Alert.alert(
                          'Are you Sure?',
                          "By Clicking 'YES' the job will be cancelled and your any amount that's with us will be transfered back to you depending upon the return policy",
                          [
                            {
                              text: 'Cancel',
